...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$CategoriesStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements CategoriesState<T> {
...
class __$$LoadedImplCopyWithImpl<T, $Res>
    extends _$CategoriesStateCopyWithImpl<T, $Res, _$LoadedImpl<T>>
...
class _$LoadedImpl<T> implements Loaded<T> {
  ...
  @override
  String toString() {
    return 'CategoriesState<$T>.loaded(data: $data)';
  }
...
abstract class Loaded<T> implements CategoriesState<T> {
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$CategoriesStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CategoriesState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements CategoriesState<T> {
