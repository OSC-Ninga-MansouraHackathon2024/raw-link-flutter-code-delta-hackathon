...
class _ApiService implements ApiService {
  _ApiService(
    ...
    baseUrl ??= 'https://mansora.onrender.com/api/v1/';
  }
  ...
  @override
  Future<ProductResponse> fetchProducts(ProductRequestBody requestBody) async {
  ...
  Future<CategoresResponse> fetchCategories(
    ...
    final _options = _setStreamType<CategoresResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CategoresResponse _value;
    try {
      _value = CategoresResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
